...
public class Main implements Runnable {
	...
	public void init() throws Exception {
		...
		kingWinnerWhite = new Player(texturedModelKingWhite, new Vector3f(-5,-1,(float)3.5),0,270,0,2,1);
		kingWinnerBlack = new Player(texturedModelKingBlack, new Vector3f(-5,-1,(float)3.5),0,270,0,2,1);
...
// put the camera
	...
	public void run() {
		...
		while (!window.shouldClose() && !Input.isKeyDown(GLFW.GLFW_KEY_ESCAPE)) {
			...
			switch (diceValue) {
				case 1:
					dice = new Player(texturedModelDice, new Vector3f(10, 0, 2), 0, 0, 180, 1, 1);
					if (player==1){
						dicew1 = new Player(texturedModelPawnWhite,  new Vector3f(10, 0, 5), 0, 0, 0, 1, 1);
						renderer.processEntity(dicew1);
					}
					else{
						diceb1 = new Player(texturedModelPawnBlack,  new Vector3f(10, 0, 5), 0, 0, 0, 1, 1);
						renderer.processEntity(diceb1);
					}
					break;
				case 2:
					dice = new Player(texturedModelDice, new Vector3f(10, 0, 2), 0, 0, 270, 1, 1);
					if (player==1){
						dicew2 = new Player(texturedModelHorseWhite,  new Vector3f(10, 0, 5), 0, 0, 0, 1, 1);
						renderer.processEntity(dicew2);
					}
					else{
						diceb2 = new Player(texturedModelHorseBlack,  new Vector3f(10, 0, 5), 0, 0, 0, 1, 1);
						renderer.processEntity(diceb2);
					}
					break;
				case 3:
					dice = new Player(texturedModelDice, new Vector3f(10, 0, 2), 90, 0, 0, 1, 1);
					if (player==1){
						dicew3 = new Player(texturedModelBishopWhite,  new Vector3f(10, 0, 5), 0, 0, 0, 1, 1);
						renderer.processEntity(dicew3);
					}
					else{
						diceb3 = new Player(texturedModelBishopBlack,  new Vector3f(10, 0, 5), 0, 0, 0, 1, 1);
				...
				case 4:
					dice = new Player(texturedModelDice, new Vector3f(10, 0, 2), 270, 0, 0, 1, 1);
					if (player==1){
						dicew4 = new Player(texturedModelRookWhite,  new Vector3f(10, 0, 5), 0, 0, 0, 1, 1);
						renderer.processEntity(dicew4);
					}
					else{
						diceb4 = new Player(texturedModelRookBlack,  new Vector3f(10, 0, 5), 0, 0, 0, 1, 1);
						renderer.processEntity(diceb4);
					}
					break;
				case 5:
					dice = new Player(texturedModelDice, new Vector3f(10, 0, 2), 0, 0, 90, 1, 1);
					if (player==1){
						dicew5 = new Player(texturedModelQueenWhite,  new Vector3f(10, 0, 5), 0, 0, 0, 1, 1);
						renderer.processEntity(dicew5);
					}
					else{
						diceb5 = new Player(texturedModelQueenBlack,  new Vector3f(10, 0, 5), 0, 0, 0, 1, 1);
						renderer.processEntity(diceb5);
					}
					break;
				case 6:
					dice = new Player(texturedModelDice, new Vector3f(10, 0, 2), 0, 0, 0, 1, 1);
					if (player==1){
						dicew6 = new Player(texturedModelKingWhite,  new Vector3f(10, 0, 5), 0, 0, 0, 1, 1);
						renderer.processEntity(dicew6);
					}
					else{
						diceb6 = new Player(texturedModelKingBlack,  new Vector3f(10, 0, 5), 0, 0, 0, 1, 1);
			...
			if (GameManager.getGameState() == 1) {
				...
				camera.setDistanceFromPlayer(20);
				...
				renderer.processEntity(kingWinnerWhite);
				renderer.processEntity(kingWinnerBlack);
				camera.setDistanceFromPlayer(30);
			}
