...
public class StaticShader extends ShaderProgram3D {
    ...
    private static final String VERTEX_FILE = "src/main/java/GUI3D/shaders/vertexShader";
    private static final String FRAGMENT_FILE = "src/main/java/GUI3D/shaders/fragmentShader";
