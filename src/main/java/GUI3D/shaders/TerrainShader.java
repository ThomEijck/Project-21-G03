...
public class TerrainShader extends ShaderProgram3D {
    ...
    private static final String VERTEX_FILE = "src/main/java/GUI3D/shaders/terrainVertexShader";
    private static final String FRAGMENT_FILE = "src/main/java/GUI3D/shaders/terrainFragmentShader";
