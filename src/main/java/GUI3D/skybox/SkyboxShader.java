...
public class SkyboxShader extends ShaderProgram3D{
    ...
    private static final String VERTEX_FILE = "src/main/java/GUI3D/skybox/skyboxVertexShader";
    private static final String FRAGMENT_FILE = "src/main/java/GUI3D/skybox/skyboxFragmentShader";
